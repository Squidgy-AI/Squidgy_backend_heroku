...
#!/usr/bin/env python3
"""
Agent Knowledge Base Upload Tool
Uses OpenAI instead of sentence-transformers for embeddings to match n8n workflow.
"""
...
def insert_documents_with_embeddings(documents: List[Dict]):
    """
    Insert documents with their embeddings into Supabase using OpenAI.
    """
    success_count = 0
...
def main():
    """
    Main function to process all files and create embeddings using OpenAI.
    """
    print("🚀 Agent Knowledge Base Upload Tool with OpenAI Embeddings")
    print("Using OpenAI's text-embedding-3-small for n8n compatibility!")
    print("="*70)
    ...
    # Ask if user wants to clear existing documents
    print("\n" + "="*60)
    print("⚠️  IMPORTANT: Do you want to delete ALL existing agent documents first?")
    print("This is recommended for a clean re-upload.")
    print("="*60)
    ...
    # Auto-proceed with embeddings
    print("\n🚀 Auto-proceeding with creating OpenAI embeddings and inserting to Supabase...")
    
    # Insert documents with embeddings
    print("\n⏳ Creating embeddings using OpenAI and inserting into Supabase...")
    success_count = insert_documents_with_embeddings(all_documents)
    
    print(f"\n✅ Done! Successfully inserted {success_count}/{len(all_documents)} documents.")
    print(f"💰 Cost: Minimal - text-embedding-3-small is very cost-effective!")
    ...
    print("\n🎉 OpenAI embedding service is working perfectly!")
    print("💡 Now compatible with n8n's OpenAI Embeddings node!")
