...
# Original GHL request model that required API credentials
...
# New secure model that doesn't require API credentials from frontend
...
async def create_ghl_subaccount(request: SecureGHLSubAccountRequest):
    ...
    try:
        ...
        # Use provided subaccount name or generate a default one
...
async def create_subaccount_and_user(request: GHLSubAccountRequest):
    ...
    try:
        # Convert to SecureGHLSubAccountRequest for the subaccount creation
        ...
        # Then create the user with dynamic data from the sub-account request
