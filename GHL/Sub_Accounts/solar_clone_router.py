#!/usr/bin/env python3
"""
FastAPI router for Solar sub-account cloning
"""
...
from GHL.Sub_Accounts.solar_clone_models import SolarCloneRequest, SolarCloneResponse, WorkflowListRequest, WorkflowListResponse
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("solar_clone_router.log"),
